...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        "text-white data-[state=active]:bg-[#157FBF] data-[state=active]:text-white",
        ...
        "outline-none focus:outline-none focus:ring-0 focus:ring-transparent focus-visible:ring-0 focus-visible:ring-transparent focus:border-transparent focus-visible:border-transparent",
        className
      )}
      {...props}
    />
